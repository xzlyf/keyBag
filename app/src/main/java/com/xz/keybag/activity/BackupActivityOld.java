...
public class BackupActivityOld extends BaseActivity {
    ...
    public int getLayoutResource() {
        return R.layout.activity_backup_old;
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        //需要滑动至屏幕一半才完全展开
                        if (event.getRawY() >= ViewUtil.getScreenSizeV2(BackupActivityOld.this)[1] / 2) {
