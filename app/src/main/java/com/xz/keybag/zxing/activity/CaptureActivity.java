package com.xz.keybag.zxing.activity;
...
import com.xz.keybag.utils.BitmapUtil;
import com.xz.keybag.zxing.camera.CameraManager;
import com.xz.keybag.zxing.decoding.CaptureActivityHandler;
import com.xz.keybag.zxing.decoding.InactivityTimer;
import com.xz.keybag.zxing.decoding.RGBLuminanceSource;
import com.xz.keybag.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
		...
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				if (result != null) {
					...
					bundle.putString(Local.INTENT_EXTRA_KEY_QR_SCAN, result.getText());
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (TextUtils.isEmpty(resultString)) {
			...
			Intent resultIntent = new Intent();
			Bundle bundle = new Bundle();
			bundle.putString(Local.INTENT_EXTRA_KEY_QR_SCAN, resultString);
